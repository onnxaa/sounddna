class DNATransferUI {
  ...
  onSliderChange(idx, val) {
    ...
    GENO.Bridge.sendParam(GENO.utils.geneToParam[idx], parseInt(val) / 100);
  }
  ...
  toggleLock(idx) {
    ...
    const paramIdx = GENO.utils.geneToParam[idx] + 14;
    GENO.Bridge.sendParam(paramIdx, gene.locked ? 1 : 0);
...
GENO.transfer = new DNATransferUI();

document.addEventListener('DOMContentLoaded', () => {
  GENO.transfer.init('transferControls');
});
