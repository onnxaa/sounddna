class DNAMorphUI {
  ...
  addPoint(profile) {
    ...
    this.updateUI();
    SDNA.Bridge.morphAdd(profile);
  }

  clear() {
    this.points = [];
    this.updateUI();
    SDNA.Bridge.morphClear();
  }
  ...
  play() {
    ...
    this.playInterval = setInterval(() => {
      ...
      if (slider) {
        ...
        SDNA.Bridge.sendParam(29, pos);
        if (SDNA.dnaMap) SDNA.dnaMap.setMorphPosition(pos * 100);
      }
    }, 10);
