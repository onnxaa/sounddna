class DNAMap {
  ...
  setupEvents() {
    ...
    this.canvas.addEventListener('wheel', (e) => {
      e.preventDefault();
      this.zoom = SDNA.utils.clamp(this.zoom + (e.deltaY > 0 ? -0.1 : 0.1), 0.3, 3);
      this.render();
    });
  }
  ...
  getMorphPoint() {
    ...
    return {
      x: SDNA.utils.lerp(a.x, b.x, segT),
      y: SDNA.utils.lerp(a.y, b.y, segT),
      z: SDNA.utils.lerp(a.z, b.z, segT),
      name: a.name + ' → ' + b.name
    };
  }
}
...
document.addEventListener('DOMContentLoaded', () => {
  SDNA.dnaMap = new DNAMap('dnaMapCanvas');
});
