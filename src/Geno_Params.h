...
static_assert(sizeof(kGeneNames) / sizeof(kGeneNames[0]) == static_cast<int>(GenoGene::Count),
              "Gene names array must match GenoGene enum count");
